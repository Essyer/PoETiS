...
_supported_mods = {
    ...
    re.compile(r'(\d+)% to all elemental resistances'): ['x% to fire resistance', 'x% to cold resistance',
    ...
    re.compile(r'(\d+) to all attributes'): ['x to dexterity', 'x to strength', 'x to intelligence'],
