...
_supported_mods = {
    ...
    re.compile(r'(\d+)% to cold resistance'): ['x% to total elemental resistances', 'x% total resistance',
                                               'x% total to cold resistance'],
    re.compile(r'(\d+)% to fire resistance'): ['x% to total elemental resistances', 'x% total resistance',
                                               'x% total to fire resistance'],
    re.compile(r'(\d+)% to lightning resistance'): ['x% to total elemental resistances',
                                                    'x% total resistance',
    ...
    re.compile(r'(\d+) to level of all fire spell skill gems'): [],
    re.compile(r'(\d+) to level of all chaos spell skill gems'): [],
    re.compile(r'(\d+) to level of all cold spell skill gems'): [],
    re.compile(r'(\d+) to level of all lightning spell skill gems'): [],
    re.compile(r'(\d+) to level of all spell skill gems'): [],
    re.compile(r'(\d+) to level of all chaos skill gems'): [],
    re.compile(r'(\d+) to level of all minion skill gems'): [],
    re.compile(r'(\d+) to level of all intelligence skill gems'): [],
    re.compile(r'(\d+) to level of all physical skill gems'): [],
    re.compile(r'(\d+) to level of all lightning skill gems'): [],
    re.compile(r'(\d+) to level of all fire skill gems'): [],
    re.compile(r'(\d+) to level of all strength skill gems'): [],
    re.compile(r'(\d+) to level of all dexterity skill gems'): [],
    re.compile(r'(\d+) to level of all cold skill gems'): [],
    re.compile(r'(\d+)% reduced flask charges used'): [],
    re.compile(r'(\d+)% increased flask mana recovery rate'): [],
    re.compile(r'(\d+)% to damage over time multiplier'): [],
    re.compile(r'(\d+)% increased attack and cast speed'): [],
    re.compile(r'(\d+)% chance to block projectile attack damage'): [],
    re.compile(r'(\d+)% increased flask life recovery rate'): [],
